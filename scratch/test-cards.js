...
const fileUrl = 'http://localhost:3000/preview-cards-test.html?t=' + Date.now()
const destPath = 'C:\\Users\\norbe\\.gemini\\antigravity\\brain\\2296d829-00a5-4831-89ec-d9bd0b658303\\preview-cards-transparency.png'

console.log(`Taking screenshot of ${fileUrl}...`)
const cmd = `"${foundPath}" --headless --disable-gpu --window-size=500,850 --screenshot="${destPath}" "${fileUrl}"`
