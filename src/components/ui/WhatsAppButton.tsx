  ...
  return (
    <aside aria-label="Atención por WhatsApp" className="fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-50 group">
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20BD5A] active:bg-[#1DA850] text-white shadow-[0_6px_24px_rgba(37,211,102,0.45)] hover:shadow-[0_8px_30px_rgba(37,211,102,0.65)] hover:scale-110 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-[#25D366]/40"
      >
        <svg
