  ...
  return (
    <section className="pt-[31px] pb-16 text-center">
      <div className="max-w-[800px] mx-auto px-4 sm:px-6">
        <div className="text-3xl sm:text-4xl text-[#C9A961] mb-4 sm:mb-6">&quot;</div>
        <p className="text-lg sm:text-2xl font-serif text-[#1E2A78] italic leading-relaxed">
        ...
        <div className="mt-6 sm:mt-8">
          <div className="font-bold text-sm sm:text-base text-[#1E2A78]">Laura G.</div>
          <div className="text-[#706A95] text-xs sm:text-sm mt-1">Mamá de Max (Estrella Brillante)</div>
        </div>
